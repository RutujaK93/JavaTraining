package com.example.Onetooneassigndemo;
...
public class OnetooneassigndemoApplication {

	public static void main(String[] args) throws Exception {
		ApplicationContext context = SpringApplication.run(OnetooneassigndemoApplication.class, args);
		...
		while(true) {
			...
			case 2:
				...
				break;
			case 3:
				List<Emp> emp_list = empl.findAll();
				System.out.println("-------------------------------------");
				for(Emp ex : emp_list) {
					System.out.println(ex.getEmp_id()+" "+ex.getName()+" "+ex.getRollobj());
				}
				System.out.println("-------------------------------------");
				break;
			case 4:
